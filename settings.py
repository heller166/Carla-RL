...
IMG_HEIGHT = 270
CAR_NPCS = 0
RESET_CAR_NPC_EVERY_N_TICKS = 0  # Resets one car NPC every given number of ticks, tick is about a second
...
MODEL_SETTINGS = {'action_dim': 2, 'critic_activation': 'linear', 'actor_activation': 'tanh'}  # 'hidden_1_units': 1024 for Xception
